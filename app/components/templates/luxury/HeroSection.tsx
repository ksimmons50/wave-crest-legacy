    ...
    <section className="relative h-screen w-full overflow-hidden bg-foreground">
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-6">
        <div className="max-w-4xl mx-auto space-y-8">
          {/* Main title */}
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extralight text-foreground tracking-[0.15em] uppercase leading-none">
            {businessName}
          </h1>

          {/* Tagline */}
          <p className="text-lg md:text-xl text-muted-foreground font-light tracking-[0.1em] max-w-xl mx-auto leading-relaxed">
            {tagline}
          </p>
          ...
          <div className="pt-8">
            <a
              href={ctaHref}
              className="group inline-flex items-center gap-4 text-muted-foreground text-sm tracking-[0.3em] uppercase hover:text-foreground transition-colors duration-500"
            >
