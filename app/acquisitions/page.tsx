        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-10 shadow-xl mb-16">
            ...
            <div className="mt-10 pt-8 border-t border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Down Payment Tiers</h3>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <div className="text-2xl font-bold text-blue-700 mb-1">8.9%</div>
                  <div className="text-sm text-gray-600">20% down payment</div>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <div className="text-2xl font-bold text-purple-700 mb-1">9.5%</div>
                  <div className="text-sm text-gray-600">15% down payment</div>
                </div>
                <div className="bg-orange-50 p-4 rounded-lg">
                  <div className="text-2xl font-bold text-orange-700 mb-1">9.9%</div>
                  <div className="text-sm text-gray-600">Below 15% down payment</div>
                </div>
              </div>
            </div>
          </div>
